function [public_vars] = plan_motion(read_only_vars, public_vars)
    ...
    % Prvních 50 iterací se robot jen točí na místě.
    % Tím LiDAR naskenuje celou mapu a mrak částic se pravděpodobně chytne
    if read_only_vars.counter < 50
        % Posíláme rychlosti [Pravé kolo, Levé kolo]
